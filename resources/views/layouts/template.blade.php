...
<head>
   ...
   <link rel="shortcut icon" href="{{ asset('assets/assets/img/ikon.png') }}" rel="icon">
         ...
         <div class="sidebar-wrapper active">
            <div class="sidebar-header position-relative">
               <div class="d-flex justify-content-between align-items-center">
                  <div class="logo">
                     <a href="{{ url('/home') }}" style="font-size: 20px">The Libraries</a>
                  </div>
                  ...
                  <li class="sidebar-item  has-sub">
                     ...
                     <ul class="submenu ">
                        ...
                        <li class="submenu-item  ">
                           <a href="{{ url('template/component-accordion.html') }}" class="submenu-link">Accordion</a>

                        </li>

                        <li class="submenu-item  ">
                           <a href="{{ url('component-alert.html') }}" class="submenu-link">Alert</a>

                        </li>

                        <li class="submenu-item  ">
                           <a href="{{ url('template/component-badge.html') }}" class="submenu-link">Badge</a>

                        </li>

                        <li class="submenu-item  ">
                           <a href="{{ url('template/component-breadcrumb.html') }}"
                              class="submenu-link">Breadcrumb</a>

                        </li>

                        <li class="submenu-item  ">
                           <a href="{{ url('template/component-button.html') }}" class="submenu-link">Button</a>

                        </li>

                        <li class="submenu-item  ">
                           <a href="{{ url('template/component-card.html') }}" class="submenu-link">Card</a>

                        </li>

                        <li class="submenu-item  ">
                           <a href="{{ url('template/component-carousel.html') }}" class="submenu-link">Carousel</a>

                        </li>

                        <li class="submenu-item  ">
                           <a href="{{ url('template/component-collapse.html') }}" class="submenu-link">Collapse</a>

                        </li>

                        <li class="submenu-item  ">
                           <a href="{{ url('templaet/component-dropdown.html') }}" class="submenu-link">Dropdown</a>
